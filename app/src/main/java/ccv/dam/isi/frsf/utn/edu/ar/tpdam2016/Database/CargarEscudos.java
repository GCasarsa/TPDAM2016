...
public class CargarEscudos {
    public static int cargarEscudo(String nombre){
        ...
        else if(nombre.equals("COLON DE SANTA FE") || nombre.equals("COLON")) return R.drawable.escudo_colon;
        else if(nombre.equals("COLON DE SAN JUSTO")) return R.drawable.escudo_colonsanjusto;
        else if(nombre.equals("COSMOS FC") || nombre.equals("COSMOS")) return R.drawable.escudo_clubcosmos;
        ...
        else if(nombre.equals("NEWELLS DE SANTA FE") || nombre.equals("NEWELLS")) return R.drawable.escudo_newells;
        else if(nombre.equals("SANJUSTINO")) return R.drawable.escudo_sanjustino;
        else if(nombre.equals("UNION DE SANTA FE") || nombre.equals("UNION")) return R.drawable.escudo_union;
        else if(nombre.equals("UNL")) return R.drawable.escudo_unl;
        else if(nombre.equals("LA SALLE JOBSON") || nombre.equals("LA SALLE")) return R.drawable.escudo_lasalle;
