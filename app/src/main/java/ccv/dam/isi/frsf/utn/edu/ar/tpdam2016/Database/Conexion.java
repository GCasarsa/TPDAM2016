...
/*
    public static void cargarEquipos(){
        ...
        listaEquipos.add(new Equipo("7","Colon de Santa Fe","escudo_colon.pnglon.png","PRIMERA DIVISIÓN", "SANTA FE", "",-31.663217, -60.725394 , "Estadio Brigadier General Estanislao López"));
        ...
        listaEquipos.add(new Equipo("13","Independiente","escudo_independientendiente.png","PRIMERA DIVISIÓN", "AVELLANEDA","",-34.670267, -58.370969,"Estadio Libertadores de América"));
        listaEquipos.add(new Equipo("14","Lanus","lanus.png","PRIMERA DIVISIÓN", "LANUS","",-34.717667, -58.383806,"Estadio La Fortaleza"));
        listaEquipos.add(new Equipo("15","Newells Old Boys","escudo_newellsnewells.png","PRIMERA DIVISIÓN", "ROSARIO", "",-32.956056, -60.661444 , "Estadio Marcelo Bielsa"));
        ...
        listaEquipos.add(new Equipo("19","Union de Santa Fe","escudo_union.pngion.png","PRIMERA DIVISIÓN", "SANTA FE", "",-31.631853, -60.715867 , "Estadio 15 de Abril"));
    ...
    public static void cargarPartidos(){
        ...
        listaPartidos.add(new Partido("5","escudo_colon de santa fe","escudo_independiente","2", "0", "Lunati","01/02","1", "GENERAL ESTANISLAO LOPEZ"));
        listaPartidos.add(new Partido("6","defensa y justicia","san lorenzo","1", "3", "Lunati","01/02","1", "NORBERTO TOMAGHELLO"));

        listaPartidos.add(new Partido("7","escudo_independiente","Racing Club","1", "2", "Lunati","31/01","2", "LIBERTADORES DE AMÉRICA"));
        ...
        listaPartidos.add(new Partido("12","defensa y justicia","escudo_colon de santa fe","1", "3", "Lunati","01/02","2", "NORBERTO TOMAGHELLO"));

        listaPartidos.add(new Partido("13","huracan","Racing Club","", "", "Lunati","31/01","3", "TOMÁS DUCÓ"));
        listaPartidos.add(new Partido("14","escudo_colon de santa fe","Gimnasia de la plata","", "", "Lunati","31/01","3", "Monumental"));
    ...
    public static void cargarFixture(){
        ...
        listaPartidos.add(new Partido("5","escudo_union de santa fe","Aldosivi","1", "0", "Lunati","28/02","5", "Jose Maria Minella"));
