...
public class AdapterTabs extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        switch (position) {
            ...
            case 2: return EquipoTabFixture.newInstance(2, "Próximos Partidos", equipoAPasar);
            case 3: return EquipoTabUbicacion.newInstance(3, "Estadio", equipoAPasar);
            default:
                return null;
        }
    }
    String[] titulos = { "INFORMACIÓN", "RESULTADOS", "PRÓXIMOS PARTIDOS", "UBICACIÓN"};
